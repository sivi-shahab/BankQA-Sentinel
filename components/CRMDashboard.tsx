...
const DEFAULT_CRM_STATS: CRMStats = {
  acquisition: {
    totalLeads: 452,
    conversionRate: 18.5,
            ...
            <div className="relative w-full max-w-4xl bg-white rounded-[32px] shadow-2xl animate-slide-up flex flex-col max-h-[90vh] overflow-hidden">
                ...
                <div className="px-8 py-6 bg-white border-t border-slate-100 flex items-center justify-between">
                    <div className="text-[10px] font-black text-slate-300 uppercase tracking-widest">
                        Generated by Hypatix.AI Intelligence Engine
                    </div>
                    <button 
...
export const CRMDashboard: React.FC<CRMDashboardProps> = ({ campaigns = [], crmStats }) => {
  ...
  const stats = crmStats || DEFAULT_CRM_STATS;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                <div className="lg:col-span-1 space-y-4">
                    ...
                    <div className="bg-slate-900 rounded-3xl p-6 shadow-xl border border-slate-800 relative overflow-hidden group">
                        ...
                        <div className="text-xl font-black text-white tracking-tight leading-none mb-1">{formatIDR(stats.acquisition.expectedRevenue)}</div>
                  ...
                  <div className="space-y-8">
                      <div>
                          <div className="flex items-baseline gap-2">
                            <span className="text-5xl font-black text-slate-800 tracking-tighter">{stats.retention.churnRate}%</span>
                      ...
                      <div>
                          <div className="text-5xl font-black text-slate-800 tracking-tighter">{formatIDR(stats.retention.avgCLV)}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-[44px] p-10 border border-slate-200 shadow-sm flex flex-col h-full">
                ...
                <div className="space-y-6 flex-1">
                    {stats.retention.segments.map((segment, idx) => (
                        <div 
                            key={idx} 
