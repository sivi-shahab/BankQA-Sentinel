  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome',
      role: 'model',
      text: 'Hypatix.AI Analyst active. Context synced with Dashboard DB. How can I help with leads, retention, or audits today?',
      timestamp: new Date()
    }
  ]);
    ...
    <div className="fixed bottom-6 right-6 w-96 h-[650px] bg-white rounded-[32px] shadow-2xl flex flex-col border border-slate-200 z-50 animate-slide-up overflow-hidden">
      ...
      <div className="bg-slate-900 p-5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-black text-white text-sm tracking-tight leading-none mb-1">Hypatix.AI Analyst</h3>
